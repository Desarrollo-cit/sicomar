...
<div class="container">
    <div class="card">
        <div class="card-header text-white bg-dark">
            <h5 class="card-title">Lecciones aprendidas</h5>
        </div>
        <div class="card-body bg-light rounded">
            <form id="formRecomendaciones">
                <div class="row justify-content-start mb-3">
                    <div class="col-lg-10">
                        <p class="lead">Agregue campos según las Lecciones aprendidas durante la Operacion</p>
                    </div>
                    <div class="col-lg-1">
                        <button type="button" id="buttonAgregarRecomendaciones" class="btn btn-primary mb-2 mb-lg-0 w-100"><i class="bi bi-plus-circle"></i></button>
                    </div>
                    <div class="col-lg-1">
                        <button type="button" id="buttonQuitarRecomendaciones" class="btn btn-danger w-100"><i class="bi bi-dash-circle"></i></button>
                    </div>
                </div>
        ...
        <div class="card-footer bg-light">
            <div class="row justify-content-center mt-1">
                <div class="col-lg-2">
                    <button type="submit" form="formRecomendaciones" class="btn btn-success w-100"><i class="bi bi-save me-2"></i>Guardar</button>
                </div>
...
<script src="<?= asset('/build/js/Reporte/lecciones.js') ?>"></script>